#!/bin/bash
#SBATCH --job-name=eval_cascade
#SBATCH --partition=batch
#SBATCH --gpus=1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --output=/data/jagucam1@alumno.upv.es/MAIN/experiments/baselines_trades/cascade/slurm-eval-%j.out
...
CSV_OUT="${EXP_DIR}/results_cascade.csv"
