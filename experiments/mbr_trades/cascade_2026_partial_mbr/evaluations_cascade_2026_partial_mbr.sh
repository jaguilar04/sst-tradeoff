#!/bin/bash
#SBATCH --job-name=cascade_2026_partial_mbr_eval
#SBATCH --partition=batch
#SBATCH --gpus=1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --output=/data/jagucam1@alumno.upv.es/MAIN/experiments/mbr_trades/cascade_2026_partial_mbr/slurm-eval-%j.out
...
CSV_OUT="${EXP_ROOT}/results_cascade_2026_partial_mbr.csv"

# ── Grid (must match inferences_cascade_2026_partial_mbr.sh) ─────────────────
