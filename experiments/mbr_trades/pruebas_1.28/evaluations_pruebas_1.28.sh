#!/bin/bash
#SBATCH --job-name=mbr_seg1280_eval
#SBATCH --partition=batch
#SBATCH --gpus=1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --output=/data/jagucam1@alumno.upv.es/MAIN/experiments/mbr_trades/pruebas_1.28/slurm-eval-%j.out
...
CSV_OUT="${EXP_ROOT}/results_pruebas_1.28.csv"

# ── Grid (must match inferences_pruebas_1.28.sh) ─────────────────────────────
